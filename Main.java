public class Main {
    ...
    public static void main(String[] args) {
        ...
        double v1 = 72 * (22 / 2) * (22 / 2) * (Math.PI);
        double v2 = 19 * (18 / 2) * (18 / 2) * (Math.PI);
        double v3 = 50 * (13 / 2) * (13 / 2) * (Math.PI);
        double v4 = 67 * (16 / 2) * (16 / 2) * (Math.PI);
        double v5 = 16 * (14 / 2) * (14 / 2) * (Math.PI);
        double v6 = 53 * (23 / 2) * (23 / 2) * (Math.PI);
        double v7 = 69 * (22 / 2) * (22 / 2) * (Math.PI);
        double v8 = 30 * (22 / 2) * (22 / 2) * (Math.PI);
        double v9 = 52 * (23 / 2) * (23 / 2) * (Math.PI);
        double v10 = 40 * (16 / 2) * (16 / 2) * (Math.PI);
        double v11 = 31 * (18 / 2) * (18 / 2) * (Math.PI);
        double v12 = 75 * (23 / 2) * (23 / 2) * (Math.PI);
